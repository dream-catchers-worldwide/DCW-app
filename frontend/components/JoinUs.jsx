          ...
          {isUK ? (
            <div>
              <div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-start">
                  ...
                  <div className="sm:col-span-2 space-y-3 sm:space-y-4 text-md py-5 font-[Convergence]">
                    ...
                    services and support to vulnerable community groups. Our
                    goal is to empower those in need and create positive change.
                    <br /> One of the ways you can help us achieve this is by
                    volunteering your time and skills. We welcome volunteers
                    from all backgrounds and experiences, and we offer a range
                    of volunteer opportunities to suit your interests and
                    availability.
                  </div>

                  {/* Image: takes 1/3 on larger screens, full width & centered on small */}
                  <div className="flex justify-center sm:justify-end">
                    <img src="/simplyConnect.png" className="h-40 w-auto" />
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 grid-rows-1 gap-1 mt-4 text-center">
                ...
                <Button
                  text="Go!"
                  link=" https://london.simplyconnect.uk/"
                  newTab={true}
                />
              </div>
              <div>
