    ...
    <div>
      {isUK ? (
        <Contents
          header="About Us"
          content={[
            'DreamCatchers WorldWide is a NFP, community interest company CIC that was founded in 2024, with the mission of helping those in need. Our team is made up of passionate individuals who are dedicated to making a positive impact on the world. We believe that every person deserves access to basic necessities, such as education, with compassion at the forefront of all we do.',

            'We work tirelessly to provide these resources to vulnerable community groups in London, UK.',
